...
def test_document_ingestion_and_rag():
    try:
        test_files = [
            "D:/LLMOps/data/Agentic AI.txt",
            "D:/LLMOps/data/History_Mankind.txt",
        ]

        uploaded_files = []
        #Appending all files to uploaded_files list
        ...
        _ = ci.built_retriever(
          ...
          lambda_mult=0.5          # Balance between relevance and diversity (0.5 is a good starting point)
        )
        ...
        if not uploaded_files:
          print("No valid files toupload. Exiting.")
          sys.exit(1)
